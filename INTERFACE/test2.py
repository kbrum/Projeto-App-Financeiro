...
class LoginApp:
    ...
    def termos(self):
        termos_janela = ctk.CTkToplevel(self.janela)
        termos_janela.geometry("450x600")

    def privacidade(self):
        privacidade_janela = ctk.CTkToplevel(self.janela)
        privacidade_janela.geometry("450x600")

    def cookies(self):
        cookies_janela = ctk.CTkToplevel(self.janela)
        cookies_janela.geometry("450x600")
